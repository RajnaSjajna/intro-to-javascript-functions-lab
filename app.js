...
console.log('Exercise 2 Result:', isAdult(37));
...
console.log('Exercise 4 Result:', generateEmail("rajne_rajne", "yahoo.com"));
...
console.log('Exercise 5 Result:', greetUser("Rajna", "morning"));
